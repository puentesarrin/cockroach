...
func (r *Replica) BeginTransaction(batch engine.Engine, ms *engine.MVCCStats, h roachpb.BatchRequest_Header, args roachpb.BeginTransactionRequest) (roachpb.BeginTransactionResponse, error) {
